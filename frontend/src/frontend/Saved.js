...
function Saved() {
  const [localProducts] = useLocalStorage("localProducts", []);
  ...
  return (
    <>
      ...
      <div className="container px-2 mx-auto">
        <h1 className="ml-4  p-2 text-purple-600 text-3xl">Saved Products</h1>
          ...
          {localProducts &&
            localProducts.map((product) => {
              return (
                <article
                  key={product.id}
                  className="hover:bg-slate-100 items-center flex w-[95%] bg-white shadow-xl hover:shadow-xl my-3"
                >
                  <a
                  ...
                  >
                    ...
                    <div className="flex flex-col justify-between dark:bg-neutral-900 w-2/3">
                      <div className="border-gray-900/10 border-s p-2 sm:p-4 sm:border-l-transparent">
                        <h3 className="line-clamp-2 font-bold text-gray-900 dark:text-white uppercase">
                          {product.name}
                        </h3>

                        <p className="line-clamp-2 dark:text-gray-100">
                          {" "}
                          {product.details}
                        </p>
                      </div>
